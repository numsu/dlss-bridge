...
install -m0644 "$root/controller/dlss_bridge.py" "$root/controller/runtime_setup.py" "$root/controller/session.py" "$root/controller/steam_config.py" "$root/controller/heroic_config.py" "$output/controller/"
